              ...
              <form onSubmit={handleEmailSignIn} className="space-y-3">
                ...
                <div className="pt-2 flex flex-col gap-2">
                  ...
                  <div className="relative flex py-1 items-center">
                    ...
                    <span className="flex-shrink mx-3 text-[10px] font-mono text-slate-500">หรือ</span>
                    <div className="flex-grow border-t border-[#1e293b]"></div>
                  </div>
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full py-2 rounded-xl bg-[#0e131f] hover:bg-[#1e293b] text-xs font-mono text-slate-200 border border-[#1e293b] hover:border-slate-500 transition-all flex items-center justify-center gap-2 font-bold"
                  >
